...
@Component({
  ...
  template: `
    <aside class="fixed left-0 top-0 z-40 w-64 h-screen transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0" 
            ...
            <div class="flex items-center">
              <div class="w-10 h-10 bg-blue-100 rounded-full flex items-center justify-center">
                @if (currentUser.profilePicture) {
                  <img [src]="currentUser.profilePicture" [alt]="currentUser.firstName + ' ' + currentUser.lastName || 'User'" 
    ...
    @if (isOpen) {
      <div (click)="closeSidebar()" 
           class="fixed inset-0 z-30 bg-black bg-opacity-50 sm:hidden"></div>
    }
  `,
  styleUrls: []
})
