...
export class GoogleCalendarService {
  ...
  private loadScript(src: string): Promise<void> {
    return new Promise((resolve, reject) => {
      if (src === 'https://apis.google.com/js/api.js' && typeof gapi !== 'undefined') {
        resolve();
        return;
      }
      if (src === 'https://accounts.google.com/gsi/client' && typeof google !== 'undefined') {
        resolve();
        return;
      }
  ...
  /**
   * Initialize Google API (without deprecated auth2)
   */
